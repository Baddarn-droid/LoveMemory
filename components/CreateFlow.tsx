        ...
        >
          ...
          >
            ...
            <p className="mt-3 max-w-xs text-xs text-white/40">
              ...
              <span className="text-amber-200/80">5–15 seconds</span> — light edit, natural unfiltered faces.
            </p>
        </div>
        </motion.div>
      )}
          ...
          {isGenerating ? (
            ...
            <>
              ...
              <p className="mb-5 max-w-sm text-xs leading-relaxed text-amber-200/75">
                ...
                <strong className="font-semibold text-amber-200">5–15 seconds</strong>) — natural unfiltered faces close to
